...
#cities {
  [zoom = 3]{
    [admin_level = 2]{
      marker-file: url('symbols/city4.svg');
      marker-line-color: @standard-halo-fill;
      marker-fill: #000;
  ...
  [zoom = 4]{
    [admin_level = 2][population > 200000],[population >= 1000000]{
      
      marker-file: url('symbols/city4.svg');
      marker-line-color: @city-halo-fill;
      marker-fill: #000;
      ...
      [admin_level = 2] { text-face-name: @condensed-bold-sans-fonts; }
  ...
  [zoom = 5]{
    [admin_level = 2][population > 100000],[population > 250000]{
      ...
      [admin_level = 2], [population >= 1000000] {
        marker-file: url('symbols/city_small.png');
      ...
      [admin_level != 2][population < 1000000] {
        marker-file: url('symbols/town_z8.png');
  ...
  [zoom = 6]{
    ...
    [admin_level = 2][population > 25000], [population > 100000]{
      ...
      [admin_level = 2] { 
        marker-file: url('symbols/city.png');
        text-face-name: @condensed-bold-sans-fonts; 
        text-transform: uppercase; 
        text-size: 12;
        text-name: "[name]]]><Placement dx='5' dy='-4' /><Placement dx='0' dy='7' /><Placement dx='5' dy='3' /><Placement dx='-5' dy='5' /><![CDATA["; 
  ...
  [zoom = 9]{
    ...
    [place='city'], [place='town'][population > 10000]{
      ...
      [place='town']{
        marker-file: url('symbols/town.png');
        text-face-name: @condensed-sans-fonts;
        text-size: 10;
        text-wrap-width: 80;
        text-wrap-before: "true";
